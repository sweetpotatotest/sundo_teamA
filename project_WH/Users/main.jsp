...
<!DOCTYPE html>
                            ...
                            <head>   
                                ...
                                <script src="https://map.vworld.kr/js/apis.do?type=Base&apiKey=A7310A01-5C02-3811-B583-DE851FC4C4C3"></script>\
...
.olControlLayerSwitcher {
    ...
    top: 20px;
            ...
            onclick="javascript:deleteLayerByName('VHYBRID');" name="rpg_1">레이어삭제하기</button>
                                ...
                                <button onclick="location.href='/mapTest'">openlayers</button>           
                              </body>
                            </html>